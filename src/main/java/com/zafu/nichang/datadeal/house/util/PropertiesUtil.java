...
public class PropertiesUtil {
    ...
    public static PropertiesModel getProperties(String filename) throws Exception {
        ...
        pm.setDazhongurl(propertiesMap.get("dazhongurl"));
        pm.setDazhongurldetal(propertiesMap.get("dazhongurldetal"));
        pm.setDazhongimgurl(propertiesMap.get("dazhongimgurl"));
        pm.setCookie(propertiesMap.get("cookie"));
        return pm;
    }
